...
class PowerFactorySim(object):
    def __init__(self, project_name='Project', binAGC = True):
        # Start PowerFactory
        ...
        if self.TS:
            line_ts = self.app.GetProjectFolder('study').GetContents('Study Case.IntCase')[0].GetContents('Line TS.SetSelect')[0].All()
    ...
    def export_csv(self, flujo:str = 'AC'):
        ...
        export.f_name = r'C:\Users\lldie\OneDrive - Universidad Técnica Federico Santa María\Universidad\Memoria\Code\TS_Loss.csv'
        export.iopt_csel = 0 
        export.locn = 1
        export.iopt_sep=0
        export.iopt_locn = 1 
        ...
        ptdf_df = pd.read_csv(r'C:\Users\lldie\OneDrive - Universidad Técnica Federico Santa María\Universidad\Memoria\Code\TS_Loss.csv',skiprows = 0,delimiter=';')
